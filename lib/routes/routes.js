...
FlowRouter.route('/newMission/qtbLogbook/printQTB', {
    name: 'printQTB',
    action() {
        BlazeLayout.render("MainLayout", {main: "printQTB"});
    }
});
...
FlowRouter.route('/newMission/qtbLogbook/printLOG', {
    name: 'printLOG',
    action() {
        BlazeLayout.render("MainLayout", {main: "printLOG"});
    }
});
